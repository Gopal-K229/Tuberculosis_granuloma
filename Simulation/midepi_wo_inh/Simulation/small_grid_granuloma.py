...
# from small_grid_granulomaSteppables import fielddd
# CompuCellSetup.register_steppable(steppable=fielddd(frequency=1))

# from small_grid_granulomaSteppables import inhkilling
# CompuCellSetup.register_steppable(steppable=inhkilling(frequency=10))
